...
> = {
  ...
  primary: {
    outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]",
    inner: "bg-gradient-to-b from-brand-400 via-brand-500 to-ink-800",
    button: "bg-gradient-to-b from-brand-500 to-brand-600",
    textColor: "text-white",
...
export const MetalButton = React.forwardRef<HTMLButtonElement, MetalButtonProps>(
  ({ children, className, variant = "default", ...props }, ref) => {
    ...
    const variants = metalButtonStyles(variant, isPressed, isHovered, isTouchDevice);
